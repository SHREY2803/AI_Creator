...
import { Link } from "react-router-dom"; // Changed Next.js Link to React Router Link for Vite+React
        ...
        {open && (
          ...
          >
            {items.map((item, idx) => (
              ...
              >
                <Link
                  to={item.href} // Changed to `to` for React Router
...
function IconContainer({ mouseX, title, icon, href }) {
  ...
  return (
    <Link to={href}>
      {" "}
      {/* Changed to `to` for React Router */}
      <motion.div
        ref={ref}
        style={{ width, height }}
